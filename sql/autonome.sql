...
INSERT INTO `station` (`id`, `x`, `y`, `nom`, `localisation`, `temperature`, `hygrometrie`, `nebulosite`, `anemometre`, `pluviometrie`, `etat`, `etat_Pluvio`, `etat_Anemo`, `etat_Nebul`, `etat_Hygro`, `etat_Temp`, `h_restart`, `remarques`, `type`) VALUES
(1, 3, 6, 'autonome', 'Lyon', 16, 3, 5, 7, 3, 3, 2, 2, 2, 2, 2, NULL, '', 0);
COMMIT;
